...
export const ALL_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'totalAssets', label: 'Total Assets', width: 'w-[110px] sm:w-[140px]', defaultVisible: true },
  { id: 'totalEquity', label: 'Total Equity', width: 'w-[110px] sm:w-[140px]', defaultVisible: true },
