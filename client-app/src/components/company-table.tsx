...
export const ALL_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'return3Year', label: '3Y Return', width: 'w-[72px] sm:w-[85px]', defaultVisible: false },
  { id: 'return5Year', label: '5Y Return', width: 'w-[72px] sm:w-[85px]', defaultVisible: false },
  { id: 'return10Year', label: '10Y Return', width: 'w-[72px] sm:w-[85px]', defaultVisible: false },
...
const columnTooltips: Partial<Record<keyof Company | 'rank' | 'name' | 'watchlist' | 'none' | 'dcfVerdict' | 'roicHistory' | 'fcfMarginHistory', string>> = {
